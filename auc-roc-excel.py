...
images = os.listdir(r'C:/Users/saktheeswaran/Desktop/finall/rttyy')

for image in images:

    img = cv2.imread(r'C:\Users/saktheeswaran/Desktop/finall/rttyy/' + image)
    # image=cv2.resize(img, (620, 480))
    ...
    for out in outs:
        ...
        for detection in out:
            ...
            if confidence > 0.5:
                ...
                sheet.append((image, classes[class_id], time_ref, confidence))
