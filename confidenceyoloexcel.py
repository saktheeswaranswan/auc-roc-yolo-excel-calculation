...
ap.add_argument('-c', '--config',
                help = 'path to yolo config file', default=r'C:\Users\saktheeswaran\Desktop\finall\yolov3-tiny.cfg')
ap.add_argument('-w', '--weights',
                help = 'path to yolo pre-trained weights', default=r'C:\Users\saktheeswaran\Desktop\finall\yolov3-tiny.weights')
ap.add_argument('-cl', '--classes',
                help = 'path to text file containing class names',default=r'C:\Users\saktheeswaran\Desktop\finall\coco.names')
args = ap.parse_args()
...
cap = cv2.VideoCapture(r'C:\Users\saktheeswaran\Desktop\finall\rttyy\download (1)')
    ...
    for out in outs:
        ...
        #each detection  has the form like this [center_x center_y width height obj_score class_1_score class_2_score ..]
            ...
            if confidence > 0.5:
                ...
                sheet.append((classes[class_id], time_ref, [confidence]))
